...
const techStack: TechItem[][] = [
  ...
  // Row 2 - 10 items
  [
    { name: "Ethereum", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/ethereum/ethereum-original.svg", url: "https://ethereum.org" },
  ...
  // Row 6 - 2 items
  [
    { name: "LangChain", icon: "https://img.icons8.com/color/48/blockchain.png", url: "https://langchain.com" },
    { name: "NLP", icon: "https://img.icons8.com/color/48/artificial-intelligence.png", url: "https://en.wikipedia.org/wiki/Natural_language_processing" },
  ],
];
